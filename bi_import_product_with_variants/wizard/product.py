...
class import_product(models.TransientModel):
    ...
    def create_product(self, values):
        ...
        vals = {
                  ...
                  'lst_price':values.get('sale_price') or False,
                  'standard_price':values.get('cost_price') or False,
                    ...
                    if self.product_search == 'by_code':
                        ...
                        if product_ids:
                            ...
                            if len(line) == 15 and self.with_variant:
                                raise Warning(_("You cann't update records with internal ref!"))
                                ...
                                if len(line) == 15:
                                    ...
                                    if atr_value == ['']:
                                        ...
                                        for pair in atr_value:
                                            ...
                                            if not attr:
                                                raise Warning(_('Please give attribute name for %s' %line[14]))
                                            if not attr_values:
                                                raise Warning(_('Please give attribute value for %s' %line[14]))
                                    ...
                                    raise Warning(_("Please give the Variant in file!"))
                        ...
                        if product_ids:
                            ...
                            if len(line) == 15 and self.with_variant:
                                raise Warning(_("You cann't update records with Barcode!"))
