...
class ReceiptDesign(models.Model):
   ...
   <div class="pos-receipt" style="direction:rtl;">
            ...
            <div class='orderlines'>
                <div style="font-weight: bolder;text-align:center; font-size: 95%; border-top: 3px dashed black;border-bottom: 3px dashed black;padding-top: 5px;padding-bottom: 5px;">
                    <div> 
                    الفاتورة :
                    ...
                    <table style="width: 100%;font-weight: bolder;">
                        <tr style="font-weight: bolder;border-bottom: 2px solid black;font-size:18px;">
                        ...
                        <tr t-foreach="receipt.orderlines" t-as="line" style="font-weight: bolder;border-bottom: 3px solid #ddd;font-size:80%;">
...
<span t-esc="widget.pos.format_currency_no_symbol(line.price_lst)" />
            ...
            <t t-if='!taxincluded'>
                <br/> 
                <div style="text-align: left; font-weight: bolder; font-size: 22px;border-top: 2px solid; padding-top: 2%;">
                ...
                <t t-foreach='receipt.tax_details' t-as='tax'>
                    <div style="font-weight: bolder;text-align: left; font-size: 22px;border-top: 2px solid; padding-top:2%;">
                      <span style="text-align: right;float: inline-start;float: right;"> 
                        <t t-esc='tax.name' />
                        </span> 
            ...
            <t t-if='receipt.total_discount or discountlist '>
                <div style="font-weight: bolder;text-align: left;font-size: 22px;border-top: 1px solid;padding-top: 2%;">
                  <span style="text-align: right;float: inline-start;float: right;"> 
                    اجمالي الخصم :
                    </span> 
            ...
            <t t-if='taxincluded'>
                <t t-foreach='receipt.tax_details' t-as='tax'>
                    <div style="font-weight: bolder;text-align: left;display:none;font-size: 22px; font-weight: 700; border-top: 1px solid;padding-top: 2%;">
                        <span style="text-align: right;float: inline-start;float: right;">
                        <t t-esc='tax.name' />
                        </span>
                ...
                <div style="font-weight: bolder;text-align: left;font-size: 22px; font-weight: 700;">
                  <span style="text-align: right;float: inline-start;float: right;"> 
                    اجمالي الضريبة :
                    </span>
            ...
            <div style="font-weight: bolder;border-top: 1px dashed black;padding-top: 5%;border-bottom: 1px dashed black;">
                ...
                <t t-foreach='paymentlines' t-as='line'>
                    <div style="font-weight: bolder;text-align: left;font-size: 22px;">
                      <span style="text-align: right;float: inline-start;float: right;"> 
                        <t t-esc='line.name' />
                         </span>
                ...
                <br/>
                <div  class="receipt-change" style="font-weight: bolder;text-align: left;font-size: 22px;">
                  <span style="text-align: right;float: inline-start;float: right;">
                    المتبقي
                     </span>
            ...
            <!-- Footer -->
            <div t-if='receipt.footer_html'  class="pos-receipt-center-align" style="font-weight: bolder;font-size: 20px;">
                <t t-raw='receipt.footer_html'/>
            </div>
            <div t-if='!receipt.footer_html and receipt.footer'  class="pos-receipt-center-align" style="font-weight: bolder;font-size: 20px;">
                <br/>
                <t t-esc='receipt.footer'/>
                <br/>
                <br/>
            </div>
            <div class='after-footer' style="font-size: 18px;">
                <t t-foreach='paymentlines' t-as='line'>
                    <t t-if='line.ticket'>
                        <br />
