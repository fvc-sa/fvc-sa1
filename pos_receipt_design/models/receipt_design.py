            ...
            <div class='orderlines'>
                <div style="text-align:center; font-size: 75%; border-top: 1px dashed black;border-bottom: 1px dashed black;padding-top: 5px;padding-bottom: 5px;">
                    ...
                    <table style="width: 100%;">
                        ...
                        <td style="border:1px solid #ddd;"><div style="text-align: right;padding-top: 10px;padding-bottom: 10px;">
...
<span t-esc="widget.pos.format_currency_no_symbol(line.price_lst)" />
                    <t t-if=" line.price != line.price_lst">
                        <t t-set="discountlist" t-value="(price_lst - line.price) + discountlist" />
                    ...
                    <t t-elif="line.discount !== 0">
                        ...
                        <td style="border:1px solid #ddd;text-align: center;"><span t-esc='widget.pos.format_currency_no_symbol(line.price_without_tax)'/></td>
                        <td style="border:1px solid #ddd;text-align: center;">
                          <span t-esc='widget.pos.format_currency_no_symbol(line.tax)'/>
                          </td>
                        <td style="border:1px solid #ddd;text-align: center;"><span t-esc='widget.pos.format_currency_no_symbol(line.price_with_tax)'/></td>
            ...
            <t t-if='!taxincluded'>
                <br/> 
                <div style="text-align: left; font-weight: 700; font-size: 20px;border-top: 2px solid; padding-top: 2%;">
            ...
            <t t-if='receipt.total_discount or discountlist '>
                <div style="text-align: left;font-size: 18px;border-top: 1px solid;padding-top: 2%;">
                  <span style="text-align: right;float: inline-start;float: right;"> 
                    اجمالي الخصم :
                    </span> 
            ...
            <br/>
            <div style="text-align: left;font-size: 20px;font-weight: 700; border-top: 2px solid;padding-top: 2%;">
                  <span style="text-align: right;float: inline-start;float: right;"> 
                  الاجمالي :
                  </span> 
            ...
            <t t-if='taxincluded'>
                <t t-foreach='receipt.tax_details' t-as='tax'>
                    <div style="text-align: left;display:none;font-size: 15px; font-weight: 700; border-top: 1px solid;padding-top: 2%;">
                        <span style="text-align: right;float: inline-start;float: right;">
                        <t t-esc='tax.name' />
                        </span>
                ...
                <div style="text-align: left;font-size: 15px; font-weight: 700;">
                  <span style="text-align: right;float: inline-start;float: right;"> 
                    اجمالي الضريبة :
                    </span>
            ...
            <div style="border-top: 1px dashed black;padding-top: 5%;border-bottom: 1px dashed black;">
                ...
                <br/>
                <div  class="receipt-change" style="text-align: left;font-size: 14px;">
                  <span style="text-align: right;float: inline-start;float: right;">
                    المتبقي
                     </span>
